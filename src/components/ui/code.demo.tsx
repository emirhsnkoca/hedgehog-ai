        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center space-x-2 group">
              ...
              <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#ff1b6b] to-[#7928ca] transition-all duration-300 group-hover:opacity-80">
                Hedgehog AI
              </span>
            </Link>
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link href="/" className="text-purple-300 hover:text-[#e02acd] transition-colors">
                Home
              </Link>
              <Link href="/features" className="text-purple-300 hover:text-[#e02acd] transition-colors">
                Features
              </Link>
              <Link href="/roadmap" className="text-purple-300 hover:text-[#e02acd] transition-colors">
                Roadmap
              </Link>
              <Link href="/team" className="text-purple-300 hover:text-[#e02acd] transition-colors">
                Team
              </Link>
              <Link href="/docs" className="text-purple-300 hover:text-[#e02acd] transition-colors">
                Docs
              </Link>
            </div>
